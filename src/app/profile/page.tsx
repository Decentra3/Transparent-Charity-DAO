...
function ProfilePageContent() {
  ...
  const { isDaoMember, hasDonorSbt, isDonor, totalFundDonated, user, setUser } =
    useOnchainStore();
  ...
  const { data: userTransactions, isLoading: transactionsLoading } =
    useTransactionsByAddress(address || "");
          ...
          >
            <div className="text-center max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-8">
                Connect your wallet to view and edit your profile information
              </p>
              <Button
                    ...
                    <div>
                      ...
                      <div className="p-3 bg-accent rounded-lg flex items-center justify-between">
                        ...
                        <Badge
                          ...
                          variant={hasDonorSbt ? "success" : "secondary"}
                        >
                          {hasDonorSbt ? "Minted" : "None"}
                        </Badge>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="p-3 bg-accent rounded-lg font-medium">
                        ${Number(totalFundDonated || "0").toFixed(2)}
                      </div>
                    </div>
                  </div>
              ...
              <Card className="border border-border bg-card">
                ...
                <CardContent>
                  {transactionsLoading ? (
                    ...
                    <div className="p-6 text-center text-muted-foreground">
                      No recent transactions found. Use BaseScan to explore more
                      transactions.
                    </div>
                  )}
                </CardContent>
...
export default function ProfilePage() {
  return (
    <RouteProtection requireConnection={false}>
      <ProfilePageContent />
    </RouteProtection>
  );
}
